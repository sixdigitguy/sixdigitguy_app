                ...
                child: Obx(
                  () => Column(
                    children: [
                      CustomRadioButton(
                        text: "lbl_english".tr,
                        value: controller.languageModelObj.value.radioList[0],
                      ...
                      CustomRadioButton(
                        text: "lbl_french".tr,
                        value: controller.languageModelObj.value.radioList[1],
                        groupValue: controller.radioGroup.value,
                        margin: getMargin(
                          top: 20,
                          right: 20,
                      ...
                      CustomRadioButton(
                        text: "lbl_spanish".tr,
                        value: controller.languageModelObj.value.radioList[2],
                        groupValue: controller.radioGroup.value,
                        margin: getMargin(
                          top: 23,
                          right: 12,
                      ...
                      CustomRadioButton(
                        ...
                        value: controller.languageModelObj.value.radioList[3],
                        groupValue: controller.radioGroup.value,
                        margin: getMargin(
                          top: 22,
                        ),
